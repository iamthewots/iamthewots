...
//       swipeData.left *= lastPoint.deltaX < threshold * -1 ? 1 : 0;
//       swipeData.right *= lastPoint.deltaX > threshold ? 1 : 0;
//       swipeData.up *= lastPoint.deltaX < threshold * -1 ? 1 : 0;
//       swipeData.down *= lastPoint.deltaY > threshold ? 1 : 0;
//     });
