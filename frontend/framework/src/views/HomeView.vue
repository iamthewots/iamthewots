...
<template>
  <main class="flex flex-direction-column padding-main gap-y-md">
    <section id="font-size" class="box grid gap-md">
      <header>
    ...
    <section id="layouts" class="flex flex-direction-column gap-y-xl">
      <div
      ...
      <div id="grid-staggered-layout" class="grid-staggered-layout gap-md">
      ...
      <div id="grid-content-layout" class="grid-content-layout gap-md">
        <div class="box">
      ...
      <div id="grid-sandwich-layout" class="box centered-content grid-sandwich-layout box-shadow-groovy gap-sm">
        <h3 class="text-color-accent-2">grid-sandwich-layout</h3>
        <img src="https://loremflickr.com/300/300/dog" alt="">
        <div>
          <p>by Leonardo Scarfò</p>
          <i>semi-responsive, fixed-layout, signle-column</i>
        </div>
      </div>
    </section>
  </main>
